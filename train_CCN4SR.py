...
class Recommender(object):
    ...
    def _initialize(self, interactions):
        ...
        self._net = CCN4SR(self._num_users,
                          self._num_items,
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--train_root', type=str, default='datasets/CDs/test/train.txt')
    # parser.add_argument('--test_root', type=str, default='datasets/CDs/test/test.txt')
    # parser.add_argument('--train_root', type=str, default='datasets/Books/test/train.txt')
    # parser.add_argument('--test_root', type=str, default='datasets/Books/test/test.txt')
    # parser.add_argument('--train_root', type=str, default='datasets/Movielens100k/train.txt')
    # parser.add_argument('--test_root', type=str, default='datasets/Movielens100k/test.txt')
    ...
    model_parser.add_argument('--d', type=int, default=50)  #50
    model_parser.add_argument('--nv', type=int, default=4)   #4
    model_parser.add_argument('--nh', type=int, default=16)

    model_parser.add_argument('--nu', type=int, default=1)  # 或者2
    model_parser.add_argument('--nu1', type=int, default=16)

    model_parser.add_argument('--drop', type=float, default=0.5)  #胶囊换成0.4
    model_parser.add_argument('--ac_conv', type=str, default='relu')
    model_parser.add_argument('--ac_fc', type=str, default='relu')
    model_config = model_parser.parse_args()
    model_config.L = config.L
    model_config.T = config.T
